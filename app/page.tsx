    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-8 px-4 py-12 sm:gap-12 sm:py-20">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 animate-slide-up">
          <Link
            href="/register"
            className="gradient-primary rounded-2xl px-8 py-4 text-base font-bold text-white shadow-xl shadow-emerald-500/25 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-2xl hover:shadow-emerald-500/30 hover:brightness-110 active:scale-[0.98] sm:px-10 sm:text-lg"
          >
            ابدأ اللعب الآن
          </Link>
          <Link
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:flex-wrap">
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium transition-all focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 dark:border-zinc-700 dark:bg-zinc-800/80 dark:text-zinc-100 sm:w-auto"
              >
      ...
      <div className="animate-slide-up">
        ...
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center">
          <input
            ...
            className="w-full rounded-xl border border-zinc-200 bg-white px-4 py-2.5 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-400 dark:border-zinc-700 dark:bg-zinc-800/80 dark:text-zinc-100 sm:w-auto sm:flex-1"
            dir="ltr"
          />
          <Button
            size="md"
